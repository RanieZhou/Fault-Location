...
def _build_graph_edge(edge: Edge, line_models: dict[str, LineModel]) -> GraphEdge:
    ...
    return GraphEdge(
        ...
        r_ohm_per_km=line_model.r_ohm_per_km if line_model else None,
        x_ohm_per_km=line_model.x_ohm_per_km if line_model else None,
        c_nf_per_km=line_model.c_nf_per_km if line_model else None,
